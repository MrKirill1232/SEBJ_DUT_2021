...
public class Test_09_nine {
    public static void main(int VAR) {
        ...
        {
            System.out.println("01. 4. 380 – 760 нм");
            System.out.println("02. 2. %");
            System.out.println("03. 1. Освітленість в лк");
            System.out.println("04. 4. E = Ia·cos3α / Kз·h2");
            System.out.println("05. 1. 150х12:40=45");
            System.out.println("06. 5. 500:45000х100=1,1%, відповідає нормам.");
            System.out.println("07. 5. всі відповіді вірні");
            System.out.println("08. 2. довговічність");
            System.out.println("09. 2. Прямого світла");
            System.out.println("10. 4. Охоронне");
        }
